...
{"selections": [{"index": 0, "reason": "选择理由（中文，一句话）"}]}
...
def build_reading_selection_messages(direction: str, plan_context: str, candidates: list) -> list:
    ...
    return [
        {"role": "system", "content": READING_SELECTION_SYSTEM},
        {"role": "user", "content": "\n".join(lines)},
    ]
