...
const features: Feature[] = [
  {
    ...
    image: '/screenshots/ingest-plan.png',
  },
  {
    id: 'graph',
    num: 'II',
  ...
  },
  {
    ...
    image: '/screenshots/plan-agent.png',
  },
  {
    id: 'explore',
    num: 'IV',
  ...
  },
  {
    ...
    image: '/screenshots/chat-save.png',
  },
  {
    id: 'lint',
    num: 'VI',
  ...
  },
  {
    ...
    image: '/screenshots/permission.png',
  },
]
...
export default function Features() {
  return (
    <section id="features" className="container-page py-24">
      {/* 概述块 */}
      <Reveal>
        <h2 className="text-3xl font-bold tracking-tight">八大亮点，一条知识闭环</h2>
        <p className="mt-3 max-w-[64ch] text-lg text-text-secondary">
            ...
            <Reveal key={f.id} delay={i * 60}>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-1.5 text-base leading-relaxed text-text-tertiary">{f.brief}</p>
                </div>
              </a>
            </Reveal>
          )
            ...
            <div key={f.id} id={`feature-${f.id}`} className="scroll-mt-20 py-16">
              <div className="grid items-center gap-10 lg:grid-cols-[4fr_6fr]">
                <div>
                  ...
                  <p className="mt-4 text-lg leading-relaxed text-text-secondary">{f.detail}</p>
